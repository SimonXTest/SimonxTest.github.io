...
# Features of mod: Design change, music(m to mute), volume, sound effects, scores, easter
...
def main():
    global FPSCLOCK, DISPLAYSURF, BASICFONT, RESET_SURF, RESET_RECT, NEW_SURF, NEW_RECT, SOLVE_SURF, SOLVE_RECT, MUSIC, VOLUME, WELCOME, score, EASTER
    ...
    ### You win v ###
        ...
        if WELCOME:
            msg = 'Click or use arrow keys to slide' # contains the message that shows at the top.
        else:
            msg = 'score: '+str(score)
